                ...
                <header className="relative rounded-[1.75rem] border border-black/8 bg-white shadow-[0_4px_24px_rgba(17,17,17,0.04)]">
                    <div className="flex flex-col gap-3 p-4 lg:p-5">
                        <div className="flex items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex items-center gap-2.5 rounded-[1.2rem] border border-black/6 bg-[#fbf7ef] px-3.5 py-2">
                                    {avatarUrl ? (
                                        <img
                                            src={avatarUrl}
                                            alt={user.name}
                                            className="size-8 rounded-[0.9rem] object-cover"
                                        />
                                    ) : (
                                    ...
                                    <div className="hidden sm:block">
                                        <p className="text-sm leading-tight font-medium text-black">
                                            {user.name}
                                        </p>

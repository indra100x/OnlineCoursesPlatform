                ...
                <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                    <div className="grid gap-5">
                        ...
                        <div className="grid gap-1.5">
                            ...
                            <textarea
                                id="bio"
                                className="min-h-24 w-full rounded-xl border border-black/12 bg-white px-3 py-2.5 text-sm text-black transition-all outline-none placeholder:text-black/30 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/10"
                                value={form.bio}
                                onChange={(event) =>
                                    setForm((c) => ({
                                        ...c,
                        ...
                        <div className="grid gap-1.5">
                            ...
                            <Input
                                ...
                                onChange={(event) =>
                                    setForm((c) => ({
                                        ...c,
                                        proof_link: event.target.value,
                                    }))
                                }
                                placeholder="Link to certificate, portfolio, or credential"
                            />
                            <p className="text-xs text-black/45">
                                Link to a certificate, teaching portfolio, or
                                any document that demonstrates your
                                qualifications.
                            </p>
                        </div>

                        <div className="rounded-xl bg-[#fff6d0] px-4 py-3 text-sm text-black/70">
                            Your registration will be reviewed by an admin. You
                            will receive access once approved.
                        </div>
...
TeacherRegister.layout = {
    ...
    description:
        'Submit your request to become a teacher. An admin will review and approve your account.',
};

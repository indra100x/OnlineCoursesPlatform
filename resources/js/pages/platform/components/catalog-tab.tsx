...
export function CatalogTab({ catalog, pagination, onPageChange, onPurchase, onToggleWishlist, onEnroll }: CatalogTabProps) {
    return (
        <>
            <div>
                ...
                {catalog.map((course) => (
                    <div key={course.id} className="rounded-[1.25rem] border border-black/8 bg-[#fffdf7] p-4">
                        <div className="flex items-start justify-between gap-3">
                            ...
                            <button type="button" onClick={() => void onToggleWishlist(course)} className="text-rose-500 shrink-0">
                                ...
                                <>
                                    ...
                                    {!course.is_enrolled ? (
                                        <Button
                                            ...
                                            onClick={() => void onEnroll(course.enrollment_code ?? '')}
                                        >
                                            Enroll now
                                        </Button>
                                    ) : null}

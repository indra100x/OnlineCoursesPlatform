        ...
        <div className="grid gap-5 xl:grid-cols-[340px,1fr]">
            <div className="brand-surface-dark p-6 text-white">
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="mt-2 rounded-full bg-[#ffd84d] px-3 py-0.5 text-[10px] font-semibold tracking-[0.18em] text-black uppercase">
                        {profile?.role ?? 'member'}
                    </p>
                    <p className="mt-4 text-sm leading-relaxed text-white/65">
                        {profile?.bio ||
                            'Add a short bio so your dashboard feels more personal and complete.'}
                    </p>
                </div>
            </div>
            ...
            <div className="space-y-5">
                <div className="brand-surface p-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-black/50">
                                Update your display name, bio, and profile
                                photo.
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        {message ? (
                            <p className="rounded-xl bg-[#fff6d0] px-3 py-2 text-xs text-black">
                                {message}
                            </p>
                        ) : null}
                        {error ? (
                ...
                <div className="brand-surface p-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-black/50">
                                Change your password without leaving the
                                dashboard.
                            </p>
                        </div>
                    </div>
